...
var DOWNLOADED_FILE = "downloaded-bitstarter-grader.html";
...
var downloaded = function(result) {
	if (result instanceof Error) {
	    console.error('Error: ' + util.format(response.message));
	} else {
	    console.error("Wrote %s", DOWNLOADED_FILE);
	    fs.writeFileSync(DOWNLOADED_FILE, result);
	    doCheck(DOWNLOADED_FILE, program.checks);
	}
    };
